...
urlpatterns = [
    ...
    path('<str:store_name>/blogs/sync/article/',       SyncSingleArticleView.as_view()),
    path('<str:store_name>/blogs/create-blog/',        CreateBlogView.as_view()),
    path('<str:store_name>/blogs/detail/',             BlogDetailView.as_view()),
    path('<str:store_name>/blogs/delete/',             DeleteBlogView.as_view()),
    path('<str:store_name>/blogs/fetch-blog-list/',    FetchBlogListView.as_view()),
